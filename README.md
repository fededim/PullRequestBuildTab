...
You can install or download it freely (for every use, see MIT license) from the [official Azure Devops Extension Marketplace](https://marketplace.visualstudio.com/items?itemName=fededim.pr-tabs-build).
